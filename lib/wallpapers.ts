...
export const WALLPAPER_ASSETS = [
  ...
  },
  {
    id: 'icons',
    displayName: 'Icons',
    description: 'A journey begins with a single star.',
    imagePath: '/wallpapers/icons.png',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
  ...
  },
  {
    ...
    description: 'A peaceful escape into a world untouched by time.',
    imagePath: '/wallpapers/rain-forest.png',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
  ...
  },
  {
    ...
    description: 'Life thrives beneath the surface.',
    imagePath: '/wallpapers/coral-reef.png',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
