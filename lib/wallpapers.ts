...
export const WALLPAPER_ASSETS = [
  ...
  },
  {
    ...
    thumbnailPath: '/wallpapers/thumbs/sunset.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#8f7890',
  },
  {
    id: 'beacon',
    displayName: 'Beacon',
    ...
    thumbnailPath: '/wallpapers/thumbs/beacon.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-medium',
    fallbackColor: '#657281',
  },
  {
    id: 'kingdom',
    displayName: 'Kingdom',
    ...
    thumbnailPath: '/wallpapers/thumbs/kingdom.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#8d8d87',
  },
  {
    id: 'mountain',
    ...
    thumbnailPath: '/wallpapers/thumbs/mountain.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#6f7770',
  },
  {
    id: 'wasteland',
    ...
    thumbnailPath: '/wallpapers/thumbs/wasteland.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-medium',
    fallbackColor: '#77756c',
  },
  {
    id: 'frutiger-aero',
    ...
    thumbnailPath: '/wallpapers/thumbs/frutiger-aero.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#8aa8aa',
  },
  {
    id: 'bedlam',
    displayName: 'Bedlam',
    ...
    thumbnailPath: '/wallpapers/thumbs/bedlam.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#8ca5bd',
  },
  {
    id: 'tomorrow',
    ...
    thumbnailPath: '/wallpapers/thumbs/tomorrow.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-medium',
    fallbackColor: '#737b84',
  },
  {
    id: 'stillwater',
    ...
    thumbnailPath: '/wallpapers/thumbs/pond.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#7d8f7d',
  },
  {
    id: 'winter',
    displayName: 'Winter',
    ...
    thumbnailPath: '/wallpapers/thumbs/cabin.jpg',
    assetType: 'png',
    collection: 'current',
    downloadable: true,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#8b8f96',
  },
  {
    id: 'signal-loss',
    ...
    thumbnailPath: '/wallpapers/thumbs/signal-loss.jpg',
    assetType: 'png',
    collection: 'hidden',
    downloadable: false,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#5d656d',
  ...
  },
  {
    ...
    thumbnailPath: '/wallpapers/thumbs/orange-horizon.jpg',
    assetType: 'png',
    collection: 'hidden',
    downloadable: false,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#8a6a4c',
  ...
  },
  {
    ...
    thumbnailPath: '/wallpapers/thumbs/moonstep.jpg',
    assetType: 'png',
    collection: 'hidden',
    downloadable: false,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-medium',
    fallbackColor: '#5c5f78',
    secretId: 'moonstep',
    exclusiveLabel: 'Jack OS Exclusive',
  },
  {
    ...
    thumbnailPath: '/wallpapers/thumbs/the-crossing.jpg',
    assetType: 'png',
    collection: 'hidden',
    downloadable: false,
    selectable: true,
    className: 'wallpaper-image wallpaper-contrast-soft',
    fallbackColor: '#857f78',
