    ...
    <div className="mx-auto flex min-h-full w-full max-w-[900px] flex-col gap-3">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 text-sm leading-relaxed text-muted-foreground text-pretty">
              Ask about Jack&apos;s education, credentials, projects, 1984 Blue Ocean, Pocket Pier,
      ...
      <form onSubmit={submit} className="space-y-2">
        ...
        <textarea
          ...
          rows={3}
          spellCheck={false}
          placeholder="Ask about projects, Pocket Pier, Blue Ocean, credentials, or contact..."
